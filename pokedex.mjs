    ...
    .then(data => {
      ...
      data.moves.forEach(move => {
        ...
        fetch(urlMove)
          ...
          .then(moveData => {
            console.log(`- ${move.move.name}, Level Learned: ${move.version_group_details[0].level_learned_at}, Method: ${move.version_group_details[0].move_learn_method.name}, Accuracy: ${moveData.accuracy}, Power: ${moveData.power}`);
          })
